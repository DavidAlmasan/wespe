...
def load_vgg(sess, vgg_path):
    ...
    # get tensors to be returned from the graph
...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # Add a skip connection between current final layer fcn8 and 4th layer (simple concatenation)
    ...
    # Upsample again to match dimensions of input image
...
def optimize(nn_last_layer, correct_label, learning_rate, num_classes):
    ...
    #dice_loss = 1 - tl.cost.dice_coe(nn_last_layer, correct_label)
