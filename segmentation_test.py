...
saveImgPath = './model_tests/images/' + 'original_segmented.png'
...
saveImgPath = './model_tests/images/' + timeName + 'enhanced_segmented.png'
inputPath = os.path.join(rel_to_main_folder, './model_tests/images/' +  'enhanced_image.png')
saveImgPath = os.path.join(rel_to_main_folder, saveImgPath)
sem_model.test_semantic_model(inputImgPath=inputPath,
                                modelPath = relModelPath,
                                saveImgPath = saveImgPath)