...
# The content image will be the generated Voronoi diagram image with the grayscale variation. If created by the 
# voronoi_generation.py script, this will have the form ###_gray.png

# The style image will be a Marchantia image, cropped to the same size as the desired synthetic image.

#### PARAMETERS TO CHANGE:

# Path to the style image, relative to current file location:
...
imsize = output_img_size # use small size if no gpu
...
style_img = image_loader(style_img_filepath)

content_list = []
for filename in content_imgs_filepath:
